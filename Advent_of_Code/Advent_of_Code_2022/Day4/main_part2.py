...
for assignments in elf_assignments: # Loop over each pair of assignments
    if assignments[0] <= assignments[2] and assignments[1] >= assignments[2]:  # 2nd contained in 1st
        counter += 1
    elif assignments[2] <= assignments[0] and assignments[3] >= assignments[0]:  # 1st contained in 2nd
        counter += 1
